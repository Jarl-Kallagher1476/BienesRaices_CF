...
import { validationSchema, imageSchema } from '@/validation/propSchema'
...
<template>
    <v-card max-width="800" flat class="mx-auto my-10">
        ...
        <v-card-subtitle class="text-h6 my-4">
        ...
        <v-form class="mt-10">
            ...
            <v-row>
                ...
                <v-col cols="12" md="4">
                    ...
                    <v-select class="mb-5" label="Baños Completos" :items="items" v-model="baños.value.value"
                ...
                <v-col cols="12" md="4">
                    ...
                    <v-select class="mb-5" label="Estacionamiento" :items="items" v-model="estacionamiento.value.value"
            ...
            <v-btn color="green-darken-3" class="font-weight-bold" block @click="submit">
                Agregar Propiedad
            </v-btn>
