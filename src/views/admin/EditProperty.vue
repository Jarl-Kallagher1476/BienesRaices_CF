...
import { validationSchema } from '@/validation/propSchema'
...
watch(property, (property) => {
    ...
    baños.value.value = property.baños
    ...
    <v-card max-width="800" flat class="mx-auto my-10">
        ...
        <v-form class="mt-10">
            ...
            <v-row>
                ...
                <v-col cols="12" md="4">
                    <v-select label="Baños" class="mb-5" :items="items" v-model="baños.value.value"
